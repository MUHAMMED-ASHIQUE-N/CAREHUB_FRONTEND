...
import StatsCard from "../../components/Admin,Doctor,Pharmacy/StatsCard"; // Assuming you move StatsCard to a separate file


// Import icons for StatsCard
              ...
              <div className="space-y-3">
                {appointments.map((appointment, index) => (
                  ...
                  >
                    ...
                    <button
                      className="rounded-full w-10 h-10 hover:bg-red-200"
