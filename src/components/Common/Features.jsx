...
const Features = ({ image, heading, paragraph }) => {
  return (
    <div className="flex flex-col items-center gap-4 p-6 transition-transform duration-300 hover:scale-105 hover:bg-blue-400/5 rounded-md">
      ...
      {/* Description */}
      <p className="text-gray-600 text-justify px-4 sm:px-6 text-sm sm:text-base">{paragraph}</p>
    </div>
  );
};
